# MoonSnap Feedback API

Cloudflare Worker for handling user feedback submissions from the MoonSnap app.
...
```typescript
from: 'MoonSnap Feedback <feedback@yourdomain.com>',
```
...
### 8. Update MoonSnap app

Copy your worker URL and update `FeedbackTab.tsx`:

```typescript
const FEEDBACK_API = 'https://moonsnap-feedback.YOUR-SUBDOMAIN.workers.dev/feedback';
```
