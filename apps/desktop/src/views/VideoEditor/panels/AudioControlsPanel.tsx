...
export function AudioControlsPanel({ project, onUpdateAudioConfig }: AudioControlsPanelProps) {
  ...
  return (
    <div className="min-w-0 space-y-3 border-t border-[var(--glass-border)] pt-2">
      <div className="flex min-w-0 items-center gap-2">
        ...
        <span className="min-w-0 truncate text-[11px] uppercase tracking-wide text-[var(--ink-subtle)]">Audio Controls</span>
      </div>
        ...
        <div className="space-y-1.5">
          <div className="flex min-w-0 items-center justify-between">
            <div className="flex min-w-0 items-center gap-1.5">
              ...
              <span className="min-w-0 truncate text-xs text-[var(--ink-muted)]">Microphone</span>
            </div>
