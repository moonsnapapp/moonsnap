...
export const DropZoneOverlay: React.FC = () => (
  <div className="absolute inset-0 z-50 bg-[var(--polar-snow)]/95 flex items-center justify-center pointer-events-none animate-fade-in">
    <div className="flex flex-col items-center gap-4 p-8 rounded-2xl border-2 border-dashed border-[var(--accent-400)] bg-[var(--accent-50)]">
      <div className="w-16 h-16 rounded-full bg-[var(--accent-100)] flex items-center justify-center">
        <Upload className="w-8 h-8 text-[var(--accent-500)]" />
      </div>
